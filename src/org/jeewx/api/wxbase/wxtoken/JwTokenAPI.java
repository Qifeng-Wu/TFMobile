...
import org.jeewx.api.core.req.model.AccessTokenCode;
import org.jeewx.api.wxuser.user.model.Wxuser;
import org.jeewx.api.wxuser.user.model.WxuserOpenId;
...
public class JwTokenAPI {
	...
	private  static AccessTokenCode atokencode = null;
	...
	public static WxuserOpenId getAccessTokenCode(String appid, String appscret,String code) throws WexinReqException{
		atokencode = new AccessTokenCode();
		atokencode.setAppid(appid);
		atokencode.setSecret(appscret);
		atokencode.setCode(code);
		JSONObject resultcode = WeiXinReqService.getInstance().doWeinxinReqJson(atokencode);
		// 正常返回
		WxuserOpenId wxuseropenid = null;
		wxuseropenid = (WxuserOpenId) JSONObject.toBean(resultcode, WxuserOpenId.class); 
		return wxuseropenid;
	}
