...
public class MSWordTool {  
     ...
     * @param indicator  
     */  
    public void  replaceBookMark(Map<String,String> indicator,String type) {  
        //循环进行替换  
        ...
        while (bookMarkIter.hasNext()) {  
            ...
            if (indicator.get(bookMarkName)!=null) {  
                bookMark.insertTextAtBookMark(indicator.get(bookMarkName), BookMark.INSERT_BEFORE,type);               
            }  
